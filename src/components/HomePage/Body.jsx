...
const Body = () => {
  return (
    <div className="main-body">
      <div className="main-body-content" data-aos="zoom-in" data-aos-duration="2000" data-aos-once="true">
      ...
      <div className="main-body-info">
        <div className="main-body-info-flex" data-aos="fade-right"  data-aos-duration="2000" data-aos-once="true">
        ...
        <div className="main-body-info-flex body-info-left" data-aos="fade-left"  data-aos-duration="2000" data-aos-once="true">
            <div className="body-icons">
            <img src={Clock}></img>
            </div>
